...
CREATE TABLE CLIENT (
    ...
    PRIMARY KEY (ID),
    BANK_ID uuid
    CONSTRAINT FK_CLIENT_BANK_ID REFERENCES BANK(ID)
);
...
create table CREDIT (
    ...
    PRIMARY KEY (ID),
    BANK_ID uuid
    CONSTRAINT FK_CREDIT_BANK_ID REFERENCES BANK(ID)
);
...
create table CREDIT_OFFER (
    ...
    PRIMARY KEY (ID),
    BANK_ID uuid
    CONSTRAINT FK_CREDIT_OFFER_BANK_ID REFERENCES BANK(ID),
    CLIENT_ID uuid
    CONSTRAINT FK_CREDIT_OFFER_CLIENT_ID REFERENCES CLIENT(ID),
    CREDIT_ID uuid
    CONSTRAINT FK_CREDIT_OFFER_CREDIT_ID REFERENCES CREDIT(ID)
);
...
create table PAYMENT_SCHEDULE (
    ...
    CONSTRAINT FK_CREDIT_OFFER_ID REFERENCES CREDIT_OFFER(ID)
);
